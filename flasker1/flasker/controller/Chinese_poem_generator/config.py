...
trainPoems = "./flasker/controller/Chinese_poem_generator/dataset/" + type + "/" + type + ".txt" # training file location
checkpointsPath = "./flasker/controller/Chinese_poem_generator//checkpoints/" + type # checkpoints location
